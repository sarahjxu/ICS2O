...
function getHint(){
  ...
  document.getElementById("clue").innerHTML = "Hint: " +  hints [catagoryIndex][hintIndex];
...
function finish(){
  ...
  document.getElementById("stats").innerHTML = "You used: " + clicks + " guesses. <br>" + wg + "% of your guesses were wrong and " + rg + "% of them were right.<br><br>You played: " + games + " games. <br>You won " + win + " games and lost " + lose + " games. <br>Your winning percentage is: " + winper + "%";
